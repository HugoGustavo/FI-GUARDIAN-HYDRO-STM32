...
/*--------------------------------------------------- BEGIN SEN0161 -------------------------------------------------------------------------------*/
uint32_t      			SEN0161_PROPERTIES_PIN                                      = (uint32_t)        ADC_CHANNEL_2; 		// ADC_CHANNEL_2;
float					SEN0161_PROPERTIES_OFFSET									= (float) 			0.00;
...
/*--------------------------------------------------- BEGIN SEN0169 -------------------------------------------------------------------------------*/
uint32_t      			SEN0169_PROPERTIES_PIN                                      = (uint32_t)		0;					// NOT_USED
...
/*--------------------------------------------------- BEGIN SEN0237 -------------------------------------------------------------------------------*/
uint32_t      			SEN0237A_PROPERTIES_PIN                                    	= (uint32_t)        0;     				// ADC_CHANNEL_12;
