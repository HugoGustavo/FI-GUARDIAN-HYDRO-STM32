...
uint32_t                SMART_WATER_PROPERTIES_MEASUREMENT_CYCLE_IN_SECONDS		    = (uint32_t)        5*60;				// 5 Minutes
...
/*--------------------------------------------------- BEGIN SEN0161 -------------------------------------------------------------------------------*/
uint32_t      			SEN0161_PROPERTIES_PIN                                      = (uint32_t)        ADC_CHANNEL_1; 	//ADC_CHANNEL_1;
float					SEN0161_PROPERTIES_OFFSET									= (float) 			5.81285;
...
/*--------------------------------------------------- BEGIN SEN0165 -------------------------------------------------------------------------------*/
uint32_t      			SEN0165_PROPERTIES_PIN                                      = (uint32_t)		ADC_CHANNEL_2; 	    //ADC_CHANNEL_2;
float					SEN0165_PROPERTIES_OFFSET									= (float) 			0.0;
...
/*--------------------------------------------------- BEGIN SEN0169 -------------------------------------------------------------------------------*/
uint32_t      			SEN0169_PROPERTIES_PIN                                      = (uint32_t)		0;
char*            		SEN0169_PROPERTIES_LABEL									= (char*) 			"ph";
float					SEN0169_PROPERTIES_OFFSET									= (float)			0.0;
/*---------------------------------------------------- END SEN0169 --------------------------------------------------------------------------------*/
...
/*--------------------------------------------------- BEGIN SEN0189 -------------------------------------------------------------------------------*/
uint32_t      			SEN0189_PROPERTIES_PIN                                      = (uint32_t)		ADC_CHANNEL_3; 	    //ADC_CHANNEL_3;
...
uint32_t				SEN0237A_PROPERTIES_VOLTAGE_POINT_1							= (uint32_t)        0.00f;
...
uint8_t					SEN0237A_PROPERTIES_TEMPERATURE_CURRENT						= (uint8_t)	        0;				    // Temperature = [0, 1, 2, 3, ... , 40]
