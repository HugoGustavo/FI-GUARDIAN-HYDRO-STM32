...
sen0165* sen0165_init(ADC_HandleTypeDef* pin, uint32_t channel){
...
uint32_t sen0165_get_channel(sen0165* sen0165){
	return sen0165 == NULL ? 0 : sen0165->pin;
}
...
float sen0165_read(sen0165* sen0165){
	...
	readings[sen0165_get_index(sen0165)] = stm32_util_read_analog(sen0165_get_pin(sen0165), sen0165_get_channel(sen0165));
