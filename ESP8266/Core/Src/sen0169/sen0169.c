...
sen0169* sen0169_init(ADC_HandleTypeDef* pin, uint32_t channel){
...
uint32_t sen0169_get_channel(sen0169* sen0169){
	return sen0169 == NULL ? 0 : sen0169->pin;
}
...
float sen0169_read(sen0169* sen0169){
	...
	readings[sen0169_get_index(sen0169)] = stm32_util_read_analog(sen0169_get_pin(sen0169), sen0169_get_channel(sen0169));
